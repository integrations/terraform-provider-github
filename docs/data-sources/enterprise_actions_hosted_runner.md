---
page_title: "github_enterprise_actions_hosted_runner (Data Source) - GitHub"
description: |-
  Get information about a specific GitHub-hosted runner in an enterprise
---

# github_enterprise_actions_hosted_runner (Data Source)

Use this data source to retrieve information about a specific GitHub-hosted runner in a GitHub enterprise by its runner ID.

## Example Usage

```terraform
data "github_enterprise_actions_hosted_runner" "example" {
...
- `runner_id` - (Required) The numeric ID of the hosted runner.
