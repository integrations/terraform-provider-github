...
func (m *NullableCollaborator) GetId()(*int64) {
    return m.id
}
...
// returns a NullableCollaborator_permissionsable when successful
...
// returns a *string when successful
func (m *NullableCollaborator) GetTypeEscaped()(*string) {
...
func (m *NullableCollaborator) SetId(value *int64)() {
    m.id = value
}
...
func (m *NullableCollaborator) SetTypeEscaped(value *string)() {
    m.typeEscaped = value
}
