...
// GlobalAdvisory_vulnerabilities_package the name of the package affected by the vulnerability.
type GlobalAdvisory_vulnerabilities_package struct {
...
func (m *GlobalAdvisory_vulnerabilities_package) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *GlobalAdvisory_vulnerabilities_package) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetEcosystem sets the ecosystem property value. The package's language or package management ecosystem.
func (m *GlobalAdvisory_vulnerabilities_package) SetEcosystem(value *SecurityAdvisoryEcosystems)() {
    m.ecosystem = value
}
