...
type RepositoryRuleCreation struct {
...
func (m *RepositoryRuleCreation) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["type"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseRepositoryRuleCreation_type)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetTypeEscaped(val.(*RepositoryRuleCreation_type))
        }
        return nil
    }
    return res
...
func (m *RepositoryRuleCreation) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *RepositoryRuleCreation) SetAdditionalData(value map[string]any)() {
...
type RepositoryRuleCreationable interface {
    ...
    GetTypeEscaped()(*RepositoryRuleCreation_type)
    SetTypeEscaped(value *RepositoryRuleCreation_type)()
}
