...
func (m *RepositoryAdvisoryCreate_vulnerabilities) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["package"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateRepositoryAdvisoryCreate_vulnerabilities_packageFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetPackageEscaped(val.(RepositoryAdvisoryCreate_vulnerabilities_packageable))
        }
        return nil
    }
...
func (m *RepositoryAdvisoryCreate_vulnerabilities) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *RepositoryAdvisoryCreate_vulnerabilities) SetPackageEscaped(value RepositoryAdvisoryCreate_vulnerabilities_packageable)() {
...
func (m *RepositoryAdvisoryCreate_vulnerabilities) SetPatchedVersions(value *string)() {
...
func (m *RepositoryAdvisoryCreate_vulnerabilities) SetVulnerableFunctions(value []string)() {
...
type RepositoryAdvisoryCreate_vulnerabilitiesable interface {
    ...
    SetPackageEscaped(value RepositoryAdvisoryCreate_vulnerabilities_packageable)()
