...
type RepositoryRuleRequiredLinearHistory struct {
...
func (m *RepositoryRuleRequiredLinearHistory) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["type"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseRepositoryRuleRequiredLinearHistory_type)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetTypeEscaped(val.(*RepositoryRuleRequiredLinearHistory_type))
        }
        return nil
    }
    return res
...
func (m *RepositoryRuleRequiredLinearHistory) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *RepositoryRuleRequiredLinearHistory) SetAdditionalData(value map[string]any)() {
...
type RepositoryRuleRequiredLinearHistoryable interface {
    ...
    GetTypeEscaped()(*RepositoryRuleRequiredLinearHistory_type)
    SetTypeEscaped(value *RepositoryRuleRequiredLinearHistory_type)()
}
