...
func (m *NullableRepository_template_repository_owner) GetTypeEscaped()(*string) {
...
func (m *NullableRepository_template_repository_owner) SetTypeEscaped(value *string)() {
    m.typeEscaped = value
}
