...
* `slug` - (Optional) The slug of the enterprise team. Exactly one of `slug` or `team_id` must be specified.
* `team_id` - (Optional) The numeric ID of the enterprise team. Exactly one of `slug` or `team_id` must be specified.
