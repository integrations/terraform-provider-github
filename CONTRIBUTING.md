...
- Export the necessary configuration for authenticating your provider with GitHub
  ...
  export GH_OWNER="<name of an organization>"
  export GH_USERNAME="<username of the user who created the token>"
  export GH_TOKEN="<token of a user with an organization account>"
  ```
