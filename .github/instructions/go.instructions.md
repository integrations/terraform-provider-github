...
> path-scoped files in this directory - it does **not** override them.
>
> In particular, the repo-wide **Severity and Nit Policy** still applies:
>
...
> rises to a real correctness, concurrency, resource-leak, or security
> issue under the severity policy.
