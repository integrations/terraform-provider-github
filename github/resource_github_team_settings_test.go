...
func TestAccGithubTeamSettings(t *testing.T) {
	...
	t.Run("manages excluded team members", func(t *testing.T) {
		t.Parallel()
			...
			Steps: []resource.TestStep{
				{
					...
					ConfigStateChecks: []statecheck.StateCheck{
						statecheck.ExpectKnownValue("github_team_settings.test",
							tfjsonpath.New("review_request_delegation").AtSliceIndex(0).AtMapKey("excluded_members"),
							knownvalue.SetExact([]knownvalue.Check{
								knownvalue.StringExact("octocat"),
								knownvalue.StringExact("defunkt"),
							})),
					},
				},
			},
