			...
			Steps: []resource.TestStep{
				{
					...
					ConfigStateChecks: []statecheck.StateCheck{
						...
						statecheck.ExpectKnownValue("data.github_team.test", tfjsonpath.New("members"), knownvalue.Null()),
						statecheck.ExpectKnownValue("data.github_team.test", tfjsonpath.New("repositories"), knownvalue.Null()),
						statecheck.ExpectKnownValue("data.github_team.test", tfjsonpath.New("repositories_detailed"), knownvalue.Null()),
					},
				},
			},
		})
