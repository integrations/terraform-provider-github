...
func Provider() terraform.ResourceProvider {
	p := &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"github_actions_organization_required_workflows":                        dataSourceGithubActionsOrganizationRequiredWorkflows(),
			...
			"github_actions_repository_required_workflows":                          dataSourceGithubActionsRepositoryRequiredWorkflows(),
			"github_actions_required_workflow":                                      dataSourceGithubActionsRequiredWorkflow(),
