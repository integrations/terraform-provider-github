	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"packages": {
				Type:        schema.TypeList,
				Computed:    true,
				Description: "An array of IP addresses in CIDR format specifying the addresses for GitHub Packages.",
				Elem:        &schema.Schema{Type: schema.TypeString},
			},
			"pages": {
				Type:        schema.TypeList,
				Computed:    true,
				Description: "An array of IP addresses in CIDR format specifying the addresses for GitHub Pages.",
				Elem:        &schema.Schema{Type: schema.TypeString},
			},
			"importer": {
				Type:        schema.TypeList,
				Computed:    true,
				Description: "An array of IP addresses in CIDR format specifying the addresses for GitHub Importer.",
				Elem:        &schema.Schema{Type: schema.TypeString},
			},
			"actions": {
				Type:        schema.TypeList,
			...
			"dependabot": {
				...
				Type:        schema.TypeList,
				Computed:    true,
				Description: "An array of IP addresses in CIDR format specifying the addresses for Dependabot.",
				Elem:        &schema.Schema{Type: schema.TypeString},
			},
			"hooks_ipv4": {
				Type:        schema.TypeList,
			...
			"packages_ipv4": {
				Type:        schema.TypeList,
				Computed:    true,
				Description: "A subset of the packages array that contains IP addresses in IPv4 CIDR format.",
				Elem:        &schema.Schema{Type: schema.TypeString},
			},
			"pages_ipv4": {
				Type:        schema.TypeList,
			...
			"packages_ipv6": {
				Type:        schema.TypeList,
				Computed:    true,
				Description: "A subset of the packages array that contains IP addresses in IPv6 CIDR format.",
				Elem:        &schema.Schema{Type: schema.TypeString},
			},
			"pages_ipv6": {
				Type:        schema.TypeList,
