	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			"root_teams_only": {
				...
				Optional:    true,
				Default:     false,
				Description: "Only return teams that are at the organization's root, i.e. no nested teams.",
			},
			"summary_only": {
				Type:        schema.TypeBool,
				Optional:    true,
			...
			"results_per_page": {
				...
				Description:      "Set the number of results per graphql query. Reducing this number can alleviate timeout errors. Accepts a value between 0 - 100.",
			},
			"teams": {
				Type:        schema.TypeList,
				Computed:    true,
				Description: "An array of GitHub teams.",
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"members": {
							...
							Description: "List of team members. Not returned if summary_only is true.",
						},
						"repositories": {
							Type:        schema.TypeList,
							Computed:    true,
							Elem:        &schema.Schema{Type: schema.TypeString},
							Description: "List of team repositories. Not returned if summary_only is true.",
						},
						"parent": {
						...
						"parent_team_id": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "The ID of the parent team, if there is one.",
						},
						"parent_team_slug": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "The slug of the parent team, if there is one.",
						},
					},
				},
			},
