			...
			Steps: []resource.TestStep{
				{
					Config: testAccGithubTeamSyncGroupMappingConfig(teamName),
					Check: resource.ComposeTestCheckFunc(
						testAccCheckGithubTeamSyncGroupMappingDisappears(t.Context(), rn),
					),
...
func testAccCheckGithubTeamSyncGroupMappingDisappears(ctx context.Context, resourceName string) resource.TestCheckFunc {
