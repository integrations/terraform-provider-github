...
const (
	...
	PROTECTION_REQUIRES_STATUS_CHECKS_CHECKS         = "checks"
	PROTECTION_REQUIRES_STATUS_CHECKS_CHECKS_CONTEXT = "checks_context"
	PROTECTION_REQUIRES_STATUS_CHECKS_CHECKS_APPID   = "checks_appid"
