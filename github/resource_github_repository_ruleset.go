...
func resourceGithubRulesetObject(d *schema.ResourceData) *github.Ruleset {
...
func expandConditions(input []interface{}) *github.RulesetConditions {
...
func flattenConditions(conditions *github.RulesetConditions) []interface{} {
...
func expandRules(input []interface{}) []*github.RepositoryRule {
	if len(input) == 0 || input[0] == nil {
		return nil
	}
...
func flattenRules(rules []*github.RepositoryRule) []interface{} {
