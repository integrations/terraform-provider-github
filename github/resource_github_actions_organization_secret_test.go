			...
			Steps: []resource.TestStep{
				{
					...
					Check: resource.ComposeTestCheckFunc(
						...
						resource.TestCheckResourceAttrSet("github_actions_organization_secret.test", "updated_at"),
					),
				},
				{
...
`
	...
	t.Run("create_update_encrypted_with_key", func(t *testing.T) {
		...
		config := `
data "github_actions_organization_public_key" "default" {}
			...
			Steps: []resource.TestStep{
				{
					...
					Check: resource.ComposeTestCheckFunc(
						resource.TestCheckResourceAttrSet("github_actions_organization_secret.test", "created_at"),
						resource.TestCheckResourceAttrSet("github_actions_organization_secret.test", "updated_at"),
						resource.TestCheckResourceAttrSet("github_actions_organization_secret.test", "remote_updated_at"),
						func(s *terraform.State) error {
							beforeCreatedAt = s.RootModule().Resources["github_actions_organization_secret.test"].Primary.Attributes["created_at"]
							return nil
						},
					),
				},
				{
					...
					Check: resource.ComposeTestCheckFunc(
						...
						resource.TestCheckResourceAttrSet("github_actions_organization_secret.test", "remote_updated_at"),
						func(s *terraform.State) error {
							afterCreatedAt := s.RootModule().Resources["github_actions_organization_secret.test"].Primary.Attributes["created_at"]
			...
			Steps: []resource.TestStep{
				{
					...
					Check: resource.ComposeTestCheckFunc(
						...
						resource.TestCheckResourceAttrSet("github_actions_organization_secret.test", "remote_updated_at"),
						func(s *terraform.State) error {
							beforeUpdatedAt = s.RootModule().Resources["github_actions_organization_secret.test"].Primary.Attributes["updated_at"]
							return nil
						},
					),
				},
				{
					...
					Check: resource.ComposeTestCheckFunc(
						...
						resource.TestCheckResourceAttrSet("github_actions_organization_secret.test", "remote_updated_at"),
						func(s *terraform.State) error {
							afterUpdatedAt := s.RootModule().Resources["github_actions_organization_secret.test"].Primary.Attributes["updated_at"]
